...
export namespace Annotation {
  ...
  export type ContextualMenuAppearance = ValueOf<
    typeof ContextualMenuAppearance
  >;
  export type ContextualMenuType = ValueOf<typeof ContextualMenuType>;
  export type ContextualMenuItemPosition = ValueOf<
    typeof ContextualMenuItemPosition
  >;
